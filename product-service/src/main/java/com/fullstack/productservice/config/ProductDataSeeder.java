...
public class ProductDataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        repository.saveAll(products.stream().filter(product -> !repository.existsById(product.getId())).toList());
        ...
        for (ProductView product : products) {
            ...
            try {
                ...
                // A concurrent startup may have created the aggregate after the read.
            }
        }
    }

    private static ProductView product(
            String id, String name, String brand, String category, long price, String imageUrl) {
